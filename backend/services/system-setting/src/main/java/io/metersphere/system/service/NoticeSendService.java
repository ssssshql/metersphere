...
//        appendInfoRow(html, "环境", environment!=null? environment.getName():"未知环境");
        ...
        appendInfoRow(html, "请求总数", String.valueOf(lastReport.getSuccessCount() + lastReport.getErrorCount()));
        appendInfoRow(html, "成功请求数", String.valueOf(lastReport.getSuccessCount()));
        appendInfoRow(html, "失败请求数", String.valueOf(lastReport.getErrorCount()));
